...
rlhfDataset = pd.read_csv("../datasets/human_sft_dataset.csv")
context = rlhfDataset["situation"].to_list()
speaker_utterance = rlhfDataset["speaker_uttr"].to_list()
response = rlhfDataset["response_human"].to_list()
...
for i in range(len(rlhfDataset)):
    ...
    rlhfDataset.to_csv("../datasets/human-impr/improve_three_dimensions_sequentially_sft_improved.csv", index=False)
...
rlhfDataset = pd.read_csv("../datasets/human_rlhf_dataset.csv")
context = rlhfDataset["situation"].to_list()
speaker_utterance = rlhfDataset["speaker_uttr"].to_list()
response = rlhfDataset["response_human"].to_list()
...
for i in range(len(rlhfDataset)):
    ...
    rlhfDataset.to_csv("../datasets/human-impr/improve_three_dimensions_sequentially_rlhf_improved.csv", index=False)