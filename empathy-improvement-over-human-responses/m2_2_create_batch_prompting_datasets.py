...
dataset = pandas.read_csv("../datasets/human-impr/human_sft_dataset.csv")
...
with open("../datasets/human-impr/naive_prompt_human_sft_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
...
with open("../datasets/human-impr/improve_all_three_dimensions_human_sft_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/identify_lacking_dimension_human_sft_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/improve_cognitive_human_sft_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/improve_affective_human_sft_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/improve_compassionate_human_sft_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")


# RLHF Dataset Improvement
dataset = pandas.read_csv("../datasets/human-impr/human_rlhf_dataset.csv")
...
with open("../datasets/human-impr/naive_prompt_human_rlhf_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/improve_all_three_dimensions_human_rlhf_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/identify_lacking_dimension_human_rlhf_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/improve_cognitive_human_rlhf_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/improve_affective_human_rlhf_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")
...
with open("../datasets/human-impr/improve_compassionate_human_rlhf_dataset.jsonl", "w", encoding="utf-8") as file:
    for item in prompts:
        file.write(json.dumps(item, ensure_ascii=False) + "\n")